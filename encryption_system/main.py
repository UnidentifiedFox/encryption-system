import secrets, json, base64, socket, argparse
...
def main():
    ...
    parser.add_argument("type", help="Select Server or Client")
    parser.add_argument("-m", "--message", help="Enter the path of the message")
...
def client(message_path, host="127.0.0.1", port=5000):
    if message_path:
        try:
